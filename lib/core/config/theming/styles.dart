...
class TextStyles {
  ...
  static TextStyle font14Grey79Regular = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey79,
  );
  ...
  static TextStyle font13WhiteF9SemiBold = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.whiteF9,
  );
  ...
  static TextStyle font16Grey55Regular = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey55,
  );
  ...
  static TextStyle font12Grey55SemiBold = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey55,
  );
  ...
  static TextStyle font12Grey7ERegular = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey7E,
  );
  static TextStyle font12Grey79Regular = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey79,
  );
  ...
  static TextStyle font16PrimaryRegular = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.primaryColor,
  );
  static TextStyle font16Grey79Regular = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey79,
  );
  static TextStyle font15Grey79Regular = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.grey79,
  );
